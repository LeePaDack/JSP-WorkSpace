...
<body>
	...
	<fmt:formatDate value="${price}" type="currency"/>
	...
	<pre>
		...
		maxFractionDigits : 지정한 소수점 자리 이하까지만 보여주기
							만약 2 이라고 작성하면 소수점 밑 숫자는 2 이상 올 수 없음 (최대 자리수)
		maxIntegerDigits : 최소 지정한 자리 이상 소수점에서 보여주기
						   만약 2 라고 작성하면 소수점 밑에 숫자는 최소 2 자리 이상은 보여야하는 것임
